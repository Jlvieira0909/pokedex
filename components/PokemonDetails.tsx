...
export function PokemonDetails({
  ...
  return (
    <motion.div
      ...
      key={data.id}
      className="absolute inset-0 text-slate-100 font-mono bg-[#0f172a]"
    >
      ...
      <div className="absolute inset-0 overflow-y-auto custom-scrollbar z-10">
        <div className="flex flex-col p-6 min-h-max pb-12">
          <div className="relative w-full h-48 shrink-0 border-b border-slate-800 bg-[url('/battle-bg.png')] bg-cover bg-center bg-no-repeat bg-sky-900 rounded-t-lg shadow-inner overflow-hidden">
          ...
          <div className="flex flex-col p-5 w-full bg-slate-900/90 rounded-b-lg relative overflow-hidden shadow-lg">
            <svg
              ...
              <div className="mb-4 relative z-10">
                ...
                <div className="flex gap-4 overflow-x-auto pb-6 custom-scrollbar px-1 pt-1">
                  {data.game_indices.map((g) => {
                    const baseColor =
                      VERSION_COLORS[g.version.name] || "#94a3b8";
                    return (
                      <motion.div
                        onMouseEnter={() => playSfx("hover")}
