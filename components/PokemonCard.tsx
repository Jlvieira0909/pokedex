  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between w-full items-start z-10 relative">
        ...
        <span className="text-[11px] font-black text-white capitalize tracking-tight truncate pl-1 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
          {name.replace(/-/g, " ")}
        </span>
      </div>
      ...
      <div className="flex-grow flex items-end justify-center pb-1 z-10 w-full relative">
        <img
          src={imgSrc}
          alt={name}
          className="max-h-14 w-auto object-contain drop-shadow-[0_5px_5px_rgba(0,0,0,0.6)] group-hover:scale-110 transition-all duration-300"
          loading="lazy"
          onError={handleError}
        />
      </div>
